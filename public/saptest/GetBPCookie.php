...
if(!empty($_POST["xmlBody"]))
{
    ...
    // allocate curl
    $curl = curl_init('http://212.150.41.90/TestForSite/SapBusinessOne_WebService_BP.asmx?op=GetBPCookie');
...
<?php
if ($xmlBody === '') {
    $xmlBody = '<?xml version="1.0" encoding="UTF-8"?><env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope"><env:Body><GetBPCookie><websiteUer>EEO061204</websiteUer></GetBPCookie></env:Body></env:Envelope>';
}
?>
