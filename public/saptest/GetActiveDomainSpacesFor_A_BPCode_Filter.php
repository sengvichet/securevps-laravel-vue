...
if(!empty($_POST["xmlBody"]))
{
    ...
    // allocate curl
    $curl = curl_init('http://212.150.41.90/TestForSite/SapBusinessOne_WebService_MainPageView.asmx?WSDL');
...
<body>
    <?php
        if ($xmlBody === '') {
            $xmlBody = '<?xml version="1.0" encoding="UTF-8"?><env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope"><env:Body><GetActiveDomainSpacesFor_A_BPCode_Filter><pageIndex>1</pageIndex><pageSize>10</pageSize><orderbyField>asc</orderbyField><orderbyDirection>asc</orderbyDirection><BPCode>BP00000066</BPCode></GetActiveDomainSpacesFor_A_BPCode_Filter></env:Body></env:Envelope>';
        }
    ?>
