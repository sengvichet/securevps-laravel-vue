...
<?php
if ($xmlBody === '') {
    $xmlBody = '<?xml version="1.0" encoding="UTF-8"?><env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope"><env:Body><SetCCUserTokenInfo><username>EEO061204</username><Last4Digits>2025</Last4Digits><isDefault>true</isDefault><removeToken>false</removeToken></SetCCUserTokenInfo></env:Body></env:Envelope>';
}
?>
