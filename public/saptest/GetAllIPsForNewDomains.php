...
if(!empty($_POST["xmlBody"]))
{
	...
	// allocate curl
	$curl = curl_init('http://212.150.41.90/TestForSite/SapBusinessOne_WebService_Inventory.asmx');
...
<?php
if ($xmlBody === '') {
    $xmlBody = '<?xml version="1.0" encoding="UTF-8"?><env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope"><env:Body><GetAllIPsForNewDomains></GetAllIPsForNewDomains></env:Body></env:Envelope>';
}
?>
