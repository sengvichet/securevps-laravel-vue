...
if(!empty($_POST["xmlBody"]))
{
	...
	// allocate curl
	$curl = curl_init('http://212.150.41.90/TestForSite/SapBusinessOne_WebService_Login.asmx');
...
<?php
if ($xmlBody === '') {
    $xmlBody = '<?xml version="1.0" encoding="UTF-8"?><env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope"><env:Body><ValidateUserName_and_Password><userName>EEO061204</userName><password>123456</password></ValidateUserName_and_Password></env:Body></env:Envelope>';
}
?>
